...
export const MAPS: readonly V1Map[] = [
  ...
  map("ring-basin", "Ring Basin", "round canyon bowls and stone hoops reward crater control", "circular terrain reads for clusters and rollers", 51, 0.9, {
    ...
    landmarks: [
      landmark("ring", 760, 628, 300, 170, "red canyon-wall ring"),
      landmark("ring", 1680, 628, 300, 170, "blue canyon-wall ring"),
      landmark("ring", 1200, 700, 560, 250, "wide center chasm ring"),
      landmark("shelf", 710, 584, 360, 40, "red high balcony"),
      landmark("shelf", 1690, 584, 360, 40, "blue high balcony"),
    ],
