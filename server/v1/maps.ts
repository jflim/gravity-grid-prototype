...
export const MAPS: readonly V1Map[] = [
  ...
  map("ring-basin", "Ringworks Basin", "broken ring bridge over canyon bowls", "weapon-readable ring bridge playground", 51, 0.9, {
    ...
    landmarks: [
      ...
      landmark("shelf", 1750, 584, 260, 40, "blue high lip"),
      landmark("shelf", 520, 704, 260, 44, "red rolling bowl"),
      landmark("shelf", 1900, 704, 260, 44, "blue rolling bowl"),
    ],
