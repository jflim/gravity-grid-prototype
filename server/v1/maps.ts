...
export const MAPS: readonly V1Map[] = [
  ...
  map("ring-basin", "Ring Basin", "round canyon bowls and stone hoops reward crater control", "circular terrain reads for clusters and rollers", 51, 0.9, {
    ...
    previewSegments: [
      segment(point(0, 800), point(190, 742), point(430, 666), point(515, 654)),
      segment(point(575, 620), point(660, 588), point(705, 584), point(775, 584), point(850, 628), point(940, 700)),
      segment(point(1015, 760), point(1120, 792), point(1200, 810), point(1280, 792), point(1385, 760)),
      segment(point(1460, 700), point(1550, 628), point(1625, 584), point(1695, 584), point(1765, 588), point(1825, 620)),
      segment(point(1885, 654), point(1970, 666), point(2210, 742), point(2400, 800)),
    ],
    landmarks: [
