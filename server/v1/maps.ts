...
export const MAPS: readonly V1Map[] = [
  ...
  map("ring-basin", "Ringworks Basin", "broken ring bridge over canyon bowls", "weapon-readable ring bridge playground", 51, 0.9, {
    spawns: {
      "red-1": spawn(430, 686, 1),
      "blue-1": spawn(1970, 686, -1),
      "red-2": spawn(705, 570, 1),
      "blue-2": spawn(1715, 560, -1),
    },
    previewSegments: [
      segment(
        point(0, 830),
      ...
      segment(point(1135, 674), point(1165, 610), point(1195, 570), point(1200, 560), point(1235, 585), point(1265, 674)),
      segment(
        point(1595, 760),
        point(1625, 590),
        point(1660, 560),
    ...
    landmarks: [
      landmark("ring", 1200, 610, 410, 220, "broken center ring"),
      landmark("bridge", 1200, 560, 270, 105, "ring bridge cap"),
      landmark("ring", 600, 700, 320, 170, "red basin ring"),
      landmark("ring", 1840, 700, 320, 170, "blue basin ring"),
      landmark("shelf", 735, 560, 190, 36, "red high staging shelf"),
      landmark("shelf", 1715, 560, 190, 36, "blue high staging shelf"),
      landmark("shelf", 600, 742, 220, 36, "red lower bowl trough"),
      landmark("shelf", 1840, 742, 220, 36, "blue lower bowl trough"),
    ],
