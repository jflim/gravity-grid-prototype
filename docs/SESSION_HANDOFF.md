...
- Local combat readability now has prototype combat hulls, floating combat markers, and playable v1 map terrain:
  ...
  - The local browser shell now uses a desktop viewport contract: cap game canvas to 1600 x 900, require 1366 x 768 visible browser pixels, center the fixed game canvas inside larger windows, and show a resize guard below minimum.
