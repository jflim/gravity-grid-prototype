...
- Desktop viewport contract uses 1600 x 900 as the design baseline, allows up to 2400 x 1350 presentation size for readability on larger displays, requires at least a 1366 x 768 visible browser viewport, and centers the fixed battlefield presentation inside larger windows so resizing does not change map strategy.
